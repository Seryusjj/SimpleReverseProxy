...
/**
 * Configuration POJO for {@link core.SProxy SProxy}
 * This will describe where the proxy is listening and what upstream services are define
 */
public class SProxyConf {
    ...
    /**
     * Parse the file on the path generating a new instance for {@link conf.SProxyConf SProxyConf}
     * @param path
     * @return
