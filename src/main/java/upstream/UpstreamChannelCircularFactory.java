...
public class UpstreamChannelCircularFactory extends UpstreamChannelFactory {

    protected final SProxyConf.ProxyConfig config;
    protected final HashMap<String, Iterator<SProxyConf.Host>> hostSelectorStrategy = new HashMap();

    public UpstreamChannelCircularFactory(SProxyConf.ProxyConfig config) {
        this.config = config;
    }
